...
export default function RelatoriosPage() {
  ...
  const [categoriaRelatorio, setCategoriaRelatorio] = useState("todos")
  ...
  useEffect(() => {
    carregarDados()
    const onStorage = (e: StorageEvent) => { if (e.key === "pedidos" || e.key === "campanhas") carregarDados() }
              ...
              <CardHeader>
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  ...
                  <div className="flex gap-2">
                    <Select value={categoriaRelatorio} onValueChange={setCategoriaRelatorio}>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <Card>
                    <CardHeader>
                      <CardTitle className="text-lg">Exportar Vendas</CardTitle>
                      <CardDescription>Exporte dados de vendas e transações</CardDescription>
                    </CardHeader>
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle className="text-lg">Exportar Clientes</CardTitle>
                      <CardDescription>Exporte dados de clientes e compradores</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div className="space-y-2">
                        ...
                        <Select defaultValue="todos">
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="compradores">Compradores recentes</SelectItem>
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle className="text-lg">Exportar Rifas</CardTitle>
                      <CardDescription>Exporte dados de rifas e cotas</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div className="space-y-2">
                        ...
                        <Select defaultValue="todas">
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="ativas">Rifas ativas</SelectItem>
                            <SelectItem value="finalizadas">Rifas finalizadas</SelectItem>
                            <SelectItem value="pendentes">Rifas pendentes</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                      <div className="space-y-2">
                      ...
                      <Button className="w-full">
                        <Download className="mr-2 h-4 w-4" /> Exportar Rifas
                      </Button>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle className="text-lg">Exportar Afiliados</CardTitle>
                      <CardDescription>Exporte dados de afiliados e comissões</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div className="space-y-2">
                        <div className="font-medium">Período</div>
                      ...
                      <Button className="w-full">
                        <Download className="mr-2 h-4 w-4" /> Exportar Afiliados
                      </Button>
                    </CardContent>
                  </Card>
                </div>
